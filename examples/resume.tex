...
%
% Devon Morris <devonmorris1992@gmail.com>
%
% Template license:
...
\position{Perception Engineer{\enskip\cdotp\enskip}Applied Mathematician}
\address{735 Independence Blvd NW, Christiansburg, Virginia 24073}

\mobile{(434)-221-4992}
\email{devonmorris1992@gmail.com}
\github{DevonMorris}
\linkedin{devonmorris1992}
\gitlab{DevonMorris}
% \stackoverflow{SO-id}{SO-name}
% \twitter{@twit}
% \skype{skype-id}
% \reddit{reddit-id}
\extrainfo{http://devonmorris.dev}
